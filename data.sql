...
insert into users values ('u2', 'Leena Markham', '1');
insert into users values ('u3', 'Branden Escobar', '1');
insert into users values ('u4', 'Digby Tierney', '1');
insert into users values ('u5', 'Harriet Beck', '1');
insert into users values ('u6', 'Aron Gu', '1');
insert into users values ('u7', 'Jeevan Dillard', '1');
insert into users values ('u8', 'Laaibah Cano', '1');
insert into users values ('u9', 'Ameila Pike', '1');
insert into users values ('u10','Davood Rafiei', '1');
insert into users values ('u11', 'Spencer Schimdt', '1');
insert into users values ('u12', 'Ryder Catonio', '1');
insert into users values ('u13', 'Dradelli Guy', '1');
insert into users values ('u14', 'Aron Gu', '1');
insert into users values ('u15', 'Mark Sanchez', '1');
insert into users values ('u16', 'Marion Trap', '1');
insert into users values ('u17', 'Mackenzie Parks', '1');
insert into users values ('u18', 'Daria Blackburn', '1');
insert into users values ('u19', 'Samuel Dixon', '1');
insert into users values ('u20','Hamed Mirzaei', '1');
insert into users values ('u21', 'Amelia Pike', '1');
insert into users values ('u22', 'Quinn Mccartney', '1');
insert into users values ('u23', 'Brenden Akhtar', '1');
insert into users values ('u24', 'Catrina Maxwell', '1');
insert into users values ('u25', 'Darsh Snyder', '1');
insert into users values ('u26', 'Pheobe Shannon', '1');
insert into users values ('u27', 'Judy Walsh', '1');
insert into users values ('u28', 'Bret Bartlett', '1');
insert into users values ('u29', 'Diogo Lowry', '1');
insert into users values ('u30', 'Rudra Duke', '1');
insert into users values ('u31', 'Mike Smith', '1');
insert into users values ('u32', 'Conner Wang', '1');
insert into users values ('u33', 'Saim Hays', '1');
insert into users values ('u34', 'Jeanne Carlson', '1');
insert into users values ('u35', 'John-Paul Whittaker', '1');
insert into users values ('u36', 'Bjorn Partridge', '1');
insert into users values ('u37', 'Dominic Chen', '1');
insert into users values ('u38', 'Aleah Mendoza', '1');
insert into users values ('u39', 'Kiyan Underwood', '1');
insert into users values ('u40', 'Wendy Fernandez', '1');
insert into users values ('u41', 'Shamima Gonzales', '1');
insert into users values ('u42', 'Mike Smith', '1');
...
--- Artists ---
insert into artists values ('a1', 'Lady Gaga', 'United States', '1');
insert into artists values ('a2', 'OneRepublic', 'United States', '1');
insert into artists values ('a3', 'Imagine Dragons', 'United States', '1');
insert into artists values ('a4', 'PSY', 'South Korea', '1');
insert into artists values ('a5', 'P!nk', 'American', '1');
insert into artists values ('a6', 'Nate Reuss', 'American', '1');
insert into artists values ('a7', 'Kelly Clarkson', 'United States', '1');
insert into artists values ('a8', 'Janelle Monáe', 'United States', '1');
insert into artists values ('a9', 'Maroon 5', 'United States', '1');
insert into artists values ('a10', 'Drake', 'Canada', '1');
insert into artists values ('a11', 'Pitbull', 'American', '1');
insert into artists values ('a12', 'Sia', 'Australian', '1');
insert into artists values ('a13', 'Neon Trees', 'American', '1');
insert into artists values ('a14', 'Carly Rae Jepsen', 'Canada', '1');
insert into artists values ('a15', 'Calvin Harris', 'Scotland', '1');
insert into artists values ('a16', 'Ellie Goulding', 'United Kingdom', '1');
insert into artists values ('a17', 'Avicii', 'Swedish', '1');
insert into artists values ('a18', 'Sean Paul', 'Jamaica', '1');
insert into artists values ('a19', 'David Guetta', 'French', '1');
insert into artists values ('a20', 'Bob Ezrin', 'Canadian', '1');
insert into artists values ('a21', 'Echosmith', 'American', '1');
insert into artists values ('a22', 'The Wanted', 'British', '1');
insert into artists values ('a23', 'Selena Gomez', 'United States', '1');
insert into artists values ('a24', 'Rixton', 'British', '1');
insert into artists values ('a25', 'American Authors', 'American', '1');
insert into artists values ('a26', 'Cobra Starship', 'American', '1');
insert into artists values ('a27', 'Captial Cities', 'American', '1');
insert into artists values ('a28', 'WALK THE MOON', 'United States', '1');
insert into artists values ('a29', 'Jason Derulo', 'American', '1');
insert into artists values ('a30', 'Taio Cruz', 'English', '1');
insert into artists values ('a31', 'The Script', 'Ireland', '1');
insert into artists values ('a32', 'Jennifer Lopez', 'American', '1');
insert into artists values ('a33', 'Shakira', 'Colombia', '1');
insert into artists values ('a34', 'The Weeknd', 'Canada', '1');
insert into artists values ('a35', 'Celine Dion', 'Canada', '1');
insert into artists values ('a36', 'Avril Lavigne', 'Canadian', '1');
insert into artists values ('a37', 'Flo Rida', 'American', '1');
insert into artists values ('a38', 'Spice Girls', 'British', '1');
insert into artists values ('a39', 'Ed Sheeran', 'England', '1');
